...
Extracted from 19 supporting files (16 Python, 0 JSON, 0 YAML, 3 docs). 39 binary files skipped.
...
### Python Module: add_slide.py
**Purpose:** Add a new slide to an unpacked PPTX directory.
- Dependency: `re`
- Dependency: `shutil`
- Dependency: `sys`
- Dependency: `pathlib.Path`
- Function: `get_next_slide_number(slides_dir)`
- Function: `create_slide_from_layout(unpacked_dir, layout_file)`
- Function: `duplicate_slide(unpacked_dir, source)`
- Function: `_add_to_content_types(unpacked_dir, dest)`
- Function: `_add_to_presentation_rels(unpacked_dir, dest)`
- Function: `_get_next_slide_id(unpacked_dir)`
- Function: `parse_source(source)`

### Python Module: clean.py
**Purpose:** Remove unreferenced files from an unpacked PPTX directory.
- Dependency: `sys`
- Dependency: `pathlib.Path`
- Dependency: `defusedxml.minidom`
- Dependency: `re`
- Function: `get_slides_in_sldidlst(unpacked_dir)`
- Function: `remove_orphaned_slides(unpacked_dir)`
- Function: `remove_trash_directory(unpacked_dir)`
- Function: `get_slide_referenced_files(unpacked_dir)`
- Function: `remove_orphaned_rels_files(unpacked_dir)`
- Function: `get_referenced_files(unpacked_dir)`
- Function: `remove_orphaned_files(unpacked_dir, referenced)`
- Function: `update_content_types(unpacked_dir, removed_files)`
- Function: `clean_unused_files(unpacked_dir)`
...
### Python Module: thumbnail.py
**Purpose:** Create thumbnail grids from PowerPoint presentation slides.
- Dependency: `argparse`
- Dependency: `subprocess`
- Dependency: `sys`
- Dependency: `tempfile`
...
- Dependency: `PIL.Image`
- Dependency: `PIL.ImageDraw`
- Dependency: `PIL.ImageFont`
- Function: `main()`
- Function: `get_slide_info(pptx_path)`
- Function: `build_slide_list(slide_info, visible_images, temp_dir)`
- Function: `create_hidden_placeholder(size)`
- Function: `convert_to_images(pptx_path, temp_dir)`
- Function: `create_grids(slides, cols, width, output_path)`
- Function: `create_grid(slides, cols, width)`