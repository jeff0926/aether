...
Extracted from 11 supporting files (8 Python, 0 JSON, 0 YAML, 3 docs). 0 binary files skipped.
...
### Python Module: check_bounding_boxes.py
- Dependency: `dataclasses.dataclass`
- Dependency: `json`
- Dependency: `sys`
- Class: `RectAndField`
- Function: `get_bounding_box_messages(fields_json_stream)`

### Python Module: check_fillable_fields.py
- Dependency: `sys`
- Dependency: `pypdf.PdfReader`

### Python Module: convert_pdf_to_images.py
- Dependency: `os`
- Dependency: `sys`
- Dependency: `pdf2image.convert_from_path`
- Function: `convert(pdf_path, output_dir, max_dim)`

### Python Module: create_validation_image.py
- Dependency: `json`
- Dependency: `sys`
- Dependency: `PIL.Image`
- Dependency: `PIL.ImageDraw`
- Function: `create_validation_image(page_number, fields_json_path, input_path, output_path)`

### Python Module: extract_form_field_info.py
- Dependency: `json`
- Dependency: `sys`
- Dependency: `pypdf.PdfReader`
...
### Python Module: extract_form_structure.py
**Purpose:** Extract form structure from a non-fillable PDF.
- Dependency: `json`
- Dependency: `sys`
- Dependency: `pdfplumber`
- Function: `extract_form_structure(pdf_path)`
- Function: `main()`

### Python Module: fill_fillable_fields.py
- Dependency: `json`
- Dependency: `sys`
- Dependency: `pypdf.PdfReader`
- Dependency: `pypdf.PdfWriter`
- Dependency: `extract_form_field_info.get_field_info`
...
### Python Module: fill_pdf_form_with_annotations.py
- Dependency: `json`
- Dependency: `sys`
- Dependency: `pypdf.PdfReader`
- Dependency: `pypdf.PdfWriter`
- Dependency: `pypdf.annotations.FreeText`
